...
import trainerMessagingRoutes from "./routes/trainer-messaging.routes.js";
...
import operationalLogRoutes from "./routes/operational-log.routes.js";
...
import trainerPlanAssignmentRoutes from "./routes/trainer-plan-assignment.routes.js";
...
app.use("/api/customer/meals", mealRoutes);
...
app.use("/api/trainer/messages", trainerMessagingRoutes);
app.use("/api/mentor/schedules", mentorSchedulesRoutes);
app.use("/api/mentor/reports", mentorReportsRoutes);
app.use("/api/mentor/operational-logs", operationalLogRoutes);
...
app.use("/api/trainer-plans", trainerPlanAssignmentRoutes);
